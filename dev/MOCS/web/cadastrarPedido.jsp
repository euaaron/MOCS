                ...
                <table border="1">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" maxlength="10" name="txtId" id="idPedido" value="${pedido.id}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" maxlength="10" name="txtQuantidade" id="quantidade" value="${pedido.quantidade}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>/></td>
                        </tr>
                        <tr>
                            <td>
